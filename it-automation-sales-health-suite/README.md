...
- Libraries:
  ...
  pip install reportlab psutil
  ```
- SMTP server (localhost in Google lab environments, or the systemr org SMTP relay)
...
As part of learning journey with the Google IT Automation with Python program, wanted to go beyond isolated lab tasks and build a cohesive automation suite that looks and feels like something used by an IT operations team.

I started with a simple requirement: summarize sales data and keep stakeholders informed automatically. From there, split the work into four parts:
...
**Report generation** – using ReportLab in `reports.py`, convert a text summary into a clean PDF report. This mirrors real IT workflows where teams generate daily/weekly PDFs for management.
...
This project reflects how approach automation in a real IT environment: start small, design modular components, and stitch them into a robust, repeatable solution.
